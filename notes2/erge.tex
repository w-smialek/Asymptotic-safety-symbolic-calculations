...
Although FRGE is an exact equation governing the scale dependence of action, introducing truncations
means that we obtain only a certain approximation. The quality of that approximation can be checked by
