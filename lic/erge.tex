...
Calculations in the cutoff scheme, employing the background field method, performed by Wilczek and Robinson [ref] have indicated
...
Later work by Pietrykowski [] have argued, that a result obtained in [ref] is specific to the choice of graviton gauge fixing and have obtained zero gravitational contribution
using different type of gauge. In [] calculations in both cutoff and dimensional regularization shemes shown no gravitational contribution.
In the dimensional regularization sheme, a number of works found the gravitational contributions to be absent.[Nieuwenhuizen; Ebert; Toms]
(The cited works all used the one-loop approximation)
Conflicting results leave the question of existence and value of $a$ from (\ref{betawilczek}) in the EFT open.
