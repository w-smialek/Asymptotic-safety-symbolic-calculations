...
% Here the functional trace $\operatorname{Tr}$ is the integration
...
% For the purpose of studying effects such as the running of abelian gauge coupling, however, an obvious
% choice is to work in the flat background and assume, that a macroscopic curvature of the spacetime have
% a negligible effect on any such results. 
% This is the convention that we adopt in this work.
\begin{equation}
    \bar{g}^{\mu\nu} = \delta^{\mu\nu}
\end{equation}
